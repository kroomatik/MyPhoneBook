        ...
        <div class ="w-4/12 bg-white p-6 rounded-lg">
            <form action ="/register" method ="post">
               ...
               {{--<div class="mb-4">
                    ...
                    <input type="text" name="role" id="role" placeholder="Your role"
                    class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('role'){{$message}} border-red-500 @enderror" value="{{ old('role') }}">
                ...
                <div class="mb-4">
                    <label for="paswword" class="sr-only">Password</label>
